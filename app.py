    ...
    if request.method == "POST":
        data = {
            ...
            "purview_type": {
                ...
                "retaliation": "retaliation" in request.form,
                "disability": "disability" in request.form,
                "gina": "gina" in request.form,
                "discrete": "discrete" in request.form,
                "non_discrete": "non_discrete" in request.form,
                "non_selection": "non_selection" in request.form,
                "accommodation": "accommodation" in request.form,
                "harassment": "harassment" in request.form,
            },
    ...
    try:
        ...
        context = {
            **data,
            ...
            "show_retaliation_section": data["purview_type"]["retaliation"],
            "show_disability_section": data["purview_type"]["disability"],
            "show_gina_section": data["purview_type"]["gina"],
            "show_discrete_section": data["purview_type"]["discrete"],
            "show_non_discrete_section": data["purview_type"]["non_discrete"],
            "show_non_selection_section": data["purview_type"]["non_selection"],
            "show_accommodation_section": data["purview_type"]["accommodation"],
            "show_harassment_section": data["purview_type"]["harassment"],
        }
        doc.render(context)
